...
namespace Jondo.Unity.Studio.Ui
{
    ...
    public static class Words
    {
            ...
            = new Dictionary<string, (string, string, string)>(StringComparer.Ordinal)
        {
            ...
            ["nav.quests"] = ("Misiones", "Quests", "Quêtes"),
            ...
            ["common.derived"] = ("deducido", "derived", "déduit"),
            ...
            ["quest.howToBuild"] = (
                "Lo construye tools/extract_quests.py a partir del volcado del cliente.",
                "tools/extract_quests.py builds it from the client dump.",
                "tools/extract_quests.py le construit à partir du dump du client."),
            ["quest.search"] = ("Buscar una misión", "Find a quest", "Chercher une quête"),
            ["quest.pick"] = ("Elige una misión para verla.",
                              "Pick a quest to see it.",
                              "Choisis une quête pour la voir."),
            ["quest.counts"] = ("{0} misiones · {1} pasos, {2} los da un NPC hablando · {3} piden otra antes",
                                "{0} quests · {1} steps, {2} handed over in conversation · {3} need another first",
                                "{0} quêtes · {1} étapes, {2} données en parlant · {3} en exigent une autre"),
            ["quest.steps"] = ("Pasos y objetivos", "Steps and objectives", "Étapes et objectifs"),
            ["quest.chain"] = ("La cadena", "The chain", "La chaîne"),
            ["quest.after"] = ("Después de", "After", "Après"),
            ["quest.leadsTo"] = ("Abre", "Opens", "Ouvre"),
            ["quest.standsAlone"] = ("No depende de ninguna otra ni abre ninguna.",
                                     "It needs no other quest and opens none.",
                                     "Elle n'en exige aucune et n'en ouvre aucune."),
            ["quest.level"] = ("Nivel {0}", "Level {0}", "Niveau {0}"),
            ["quest.dungeon"] = ("mazmorra", "dungeon", "donjon"),
            ["quest.party"] = ("de grupo", "party", "de groupe"),
            ["quest.event"] = ("evento", "event", "événement"),
            ["quest.repeatable"] = ("repetible", "repeatable", "répétable"),
            ["quest.givenBy"] = ("La da {0}, en {1}", "Given by {0}, at {1}", "Donnée par {0}, à {1}"),
            ["quest.noGiver"] = ("No la reparte ningún NPC.",
                                 "No NPC hands it out.",
                                 "Aucun PNJ ne la donne."),
            ["quest.criterion"] = ("Para que te la ofrezcan:",
                                   "Offered when:",
                                   "Proposée quand :"),
            ["quest.spoken"] = ("· lo dice un NPC", "· said by an NPC", "· dit par un PNJ"),
            ["quest.saysThis"] = ("Se entrega con la línea {0}:",
                                  "Handed over on line {0}:",
                                  "Donnée à la ligne {0} :"),
            ["quest.lineMissing"] = ("La línea {0} no está en la tabla de diálogos.",
                                     "Line {0} is not in the dialogue table.",
                                     "La ligne {0} n'est pas dans la table des dialogues."),
            ["quest.gives"] = ("Da: {0}", "Gives: {0}", "Donne : {0}"),
            ["quest.spellPrize"] = ("hechizo {0}", "spell {0}", "sort {0}"),
            ["quest.emotePrize"] = ("emote {0}", "emote {0}", "émote {0}"),
            ["quest.titlePrize"] = ("título {0}", "title {0}", "titre {0}"),
        };
    }
}
