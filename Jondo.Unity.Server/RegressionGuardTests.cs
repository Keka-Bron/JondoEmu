...
namespace Jondo.Unity.Launcher
{
    public static class RegressionGuardTests
    {
        ...
        private static void AssertInteractiveRegistry()
        {
            ...
            // encuentra por su casilla para el disparo de fin de movimiento/JQI conservado por
            // Jondo. El índice también impide dos rutas activas sobre la misma celda.
            ...
            // La escalera gfx 62018 sigue la misma ruta genérica que el sol: clic por ElementId y
            // fin de movimiento/JQI por SourceCellId, ambos con USE114.
