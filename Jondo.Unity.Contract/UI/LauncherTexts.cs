...
namespace Jondo.Unity.Launcher.UI
{
    ...
    public sealed class LauncherTexts
    {
        ...
        public string ServerAddressFormat { get; init; } = "";
        public string ServerAddressTitle { get; init; } = "";
        public string ServerAddressHelp { get; init; } = "";
        public string InvalidServerAddress { get; init; } = "";
        public string SaveButton { get; init; } = "";
        public string CancelButton { get; init; } = "";
        public string ClientSupportInstall { get; init; } = "";
        public string ClientSupportReady { get; init; } = "";
        public string ClientSupportInstalling { get; init; } = "";
        public string ClientSupportInstalled { get; init; } = "";
        ...
        private static readonly Dictionary<Language, LauncherTexts> Catalog = new()
        {
            [Language.Es] = new LauncherTexts
            {
                ...
                ServerAddressFormat = "SERVIDOR: {0}",
                ServerAddressTitle = "Servidor de Jondo",
                ServerAddressHelp = "Escribe el dominio/IP del servidor o la URL HTTPS de su proxy. Los puertos del juego se configuran automáticamente.",
                InvalidServerAddress = "La dirección no es válida. Usa un dominio/IP o una URL http(s) sin ruta, consulta ni credenciales.",
                SaveButton = "GUARDAR",
                CancelButton = "CANCELAR",
                ClientSupportInstall = "INSTALAR SOPORTE DEL CLIENTE",
                ClientSupportReady = "MELONLOADER + JONDOFIX: LISTOS",
                ClientSupportInstalling = "INSTALANDO SOPORTE DEL CLIENTE…",
                ClientSupportInstalled = "El soporte del cliente se instaló correctamente.",
            ...
            [Language.En] = new LauncherTexts
            {
                ...
                ServerAddressFormat = "SERVER: {0}",
                ServerAddressTitle = "Jondo server",
                ServerAddressHelp = "Enter the server domain/IP or its HTTPS reverse-proxy URL. Game service ports are configured automatically.",
                InvalidServerAddress = "The address is invalid. Use a domain/IP or an http(s) URL without a path, query, or credentials.",
                SaveButton = "SAVE",
                CancelButton = "CANCEL",
                ClientSupportInstall = "INSTALL CLIENT SUPPORT",
                ClientSupportReady = "MELONLOADER + JONDOFIX: READY",
                ClientSupportInstalling = "INSTALLING CLIENT SUPPORT…",
                ClientSupportInstalled = "Client support was installed successfully.",
            ...
            [Language.Fr] = new LauncherTexts
            {
                ...
                ServerAddressFormat = "SERVEUR : {0}",
                ServerAddressTitle = "Serveur Jondo",
                ServerAddressHelp = "Saisissez le domaine/IP du serveur ou l’URL HTTPS de son proxy. Les ports de jeu sont configurés automatiquement.",
                InvalidServerAddress = "L’adresse est invalide. Utilisez un domaine/IP ou une URL http(s) sans chemin, requête ni identifiants.",
                SaveButton = "ENREGISTRER",
                CancelButton = "ANNULER",
                ClientSupportInstall = "INSTALLER LE SUPPORT CLIENT",
                ClientSupportReady = "MELONLOADER + JONDOFIX : PRÊTS",
                ClientSupportInstalling = "INSTALLATION DU SUPPORT CLIENT…",
                ClientSupportInstalled = "Le support client a été installé correctement.",
