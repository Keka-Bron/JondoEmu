...
> ⚠️ **Compatibility Notice**: This emulator strictly requires **Dofus 3 Client Version 3.6.4.3**. It is **NOT compatible** with newer or latest versions of the official Dofus client due to underlying protocol changes. The emulator will be migrated to the last version once a MVP product is achieved. **Dofus 3 Client Version 3.6.4.3 LINK**: [https://www.swisstransfer.com/d/cf829157-fd95-4add-8dbc-9b3e03b9dff3](https://www.swisstransfer.com/d/cf829157-fd95-4add-8dbc-9b3e03b9dff3)
